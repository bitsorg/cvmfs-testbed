...
#
# Flags:
#   -t <tar>   path to the tar file whose contents are to be published
#   -b <base>  destination sub-path within the repository (no leading slash)
if cvmfs_server ingest \
    ...
    echo "  /cvmfs/${REPO_NAME}/${INGEST_BASE}/large/large-20m.bin"
    echo "  /cvmfs/${REPO_NAME}/${INGEST_BASE}/links/hardlink.txt"
